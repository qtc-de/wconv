...
parser_ace = subparsers.add_parser('ace', help='ACE related actions')
parser_ace.add_argument('ace', nargs='?', help='ACE to operate on (default format: integer)')
parser_ace.add_argument('--hex', action='store_true', help='the specified value is an ACE hex string')
parser_ace.add_argument('--sddl', action='store_true', help='the specified value is an ACE sddl string')
...
parser_sd.add_argument('sd', metavar='b64', help='security descriptor (default format: base64)')
